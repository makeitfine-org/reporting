...
COMMENT
ON TABLE report_config IS 'Per-client reporting configuration owned by the reporting microservice';
COMMENT
ON TABLE scheduled_reports IS 'Scheduled report definitions (cron-based)';
COMMENT
ON TABLE alert_rules IS 'Alert threshold rules for banking analytics';
